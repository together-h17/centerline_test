# -*- coding: utf-8 -*-
"""
Created on Thu Nov  7 09:21:27 2024
...
output_combined_path = os.path.join(root, 'combined_output_v5.shp')
output_line_shapefile = os.path.join(root, 'output_line_v5.shp')
...
# 再次排除這些點
filtered_gdf = filtered_gdf.drop(list(points_to_exclude_counts)) # 那為什麼要91行？
...
# =============================================================================
#     # 判斷同點
#     if second_closest_point.x == closest_point.x and second_closest_point.y == closest_point.y:
#         second_attrs['samepoint'] = 1
#         second_nearest_points.append({**second_attrs, 'geometry': node.geometry})
#     else:
#         second_attrs['samepoint'] = 0
...
for npt, sp in zip(nearest_points, second_nearest_points):
    if sp['samepoint'] == 0 and sp['crossover'] < 2:
        midpoint_geom = Point(
